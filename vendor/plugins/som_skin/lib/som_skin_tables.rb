    ...
    class SomTableColumn 
      ...
      def footerize(collection=nil)
        ...
        if summary
          ...
          content_tag(:td, foot_opts) { self.footer_proc.call(collection) }
        end
      end
